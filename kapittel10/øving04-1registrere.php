<?php
    ...
    if(isset($_REQUEST['registrert'])) {
        ...
        $administrator = isset($_REQUEST['administrator']) ? 1 : 0;

        $sql = "INSERT INTO medlemmerk10ø3 (m_bnavn, m_passord, m_fnavn, m_enavn, m_epost, m_adresse, m_postnummer, m_poststed, m_admin)
                VALUES (:bnavn, :passord, :fnavn, :enavn, :epost, :adresse, :postnummer, :poststed, :administrator)";
        $sp = $pdo->prepare($sql);
        ...
        $sp->bindParam(":administrator", $administrator, PDO::PARAM_INT);
...
<body>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"> <br>
        ...
        Administrator: <input type="checkbox" name="administrator"><br>
